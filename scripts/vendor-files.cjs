...
const codecNames = ['pako-2.1.0.min.js', 'UPNG-2.1.0.js', 'UTIF-3.1.0.js', 'gifenc-1.0.3.browser.js', 'heic-decoder.js', 'jpeg-decoder.js', 'modern-codecs.js'];
...
module.exports = { modernSourceNames, heicSourceNames, jpegSourceNames, binaryNames, codecNames, licenseNames, sourceNames, sourceLicenses, extraSources };

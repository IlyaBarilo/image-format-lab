...
export const isBmpFormat = format => format === 'bmp24' || format === 'bmp32';
export const formatOptionValue = format => isBmpFormat(format) ? 'bmp' : format;
export const formatFromOption = (value, depth) => value === 'bmp' ? (String(depth) === '32' ? 'bmp32' : 'bmp24') : value;
export const FORMAT_OPTIONS = Object.entries(FORMAT_DEFS)
  .filter(([format]) => format !== 'bmp32')

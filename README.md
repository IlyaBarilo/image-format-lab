...
| Найти отличия в изображении | Карты различий RGB/alpha с исходником, общее усиление и выбор области для всех графиков |
...
| --- | --- | --- |
| JPEG, PNG | Средствами браузера | Средствами браузера; для JPEG — качество и заливка прозрачности |
...
| ICO | Наибольший PNG внутри ICO; прочие варианты — при поддержке браузера | 7 PNG-размеров: 16, 24, 32, 48, 64, 128, 256 px |
| PNG opt | Как обычный PNG | Через встроенные UPNG и pako |
...
| HEIC/HEIF | Через встроенные libheif 1.23.4 / libde265 1.1.2; основное изображение HEVC | HEIC: libheif + Kvazaar 2.3.2, качество 1–100 |
...
Lossless сохраняет пиксели RGBA8, поступившие на кодирование, без обещания
сохранить исходную разрядность, профиль, метаданные или анимацию.
...
- JPEG/BMP24 заменяют прозрачность заливкой; GIF поддерживает двоичную прозрачность.
  ...
  метаданные не копируются; сохранение ICC/HDR через Canvas не гарантируется.
...
- Предел исходника — **40 мегапикселей**, накопленных результатов ZIP — **256 МиБ**.

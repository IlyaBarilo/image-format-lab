...
исходные коды хранятся отдельно и передаются кодировщику PNG16/JP2.
...
Для точного PNG16 и JP2 с поддерживаемым RGB ICC-профилем просмотр и сравнение
используют преобразованную копию в sRGB. Исходные отсчёты и профиль остаются
отдельно и передаются кодировщику PNG16 или JP2 без изменения размера;
...
Поддерживаются метка sRGB, отсутствие цветовых блоков и RGB ICC-профили с
...
- JPEG/BMP8/BMP24 заменяют прозрачность заливкой; GIF поддерживает двоичную прозрачность.
  ...
  а исходный поддерживаемый ICC сохраняет в PNG16 без изменения размера.

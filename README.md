...
PNG16 и поддерживаемый TIFF16 сохраняют исходные 16-битные отсчёты. Другие lossless-режимы сохраняют
...
при подтверждённой поддержке браузера PNG16 и TIFF16 показываются через

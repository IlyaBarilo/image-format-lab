...
PNG16, поддерживаемый TIFF16 и JPEG 2000 без потерь сохраняют исходные 16-битные отсчёты. Другие lossless-режимы сохраняют
пиксели RGBA8, поступившие на кодирование, без обещания сохранить исходную
разрядность, профиль, метаданные или анимацию. Исключение — отдельное
...
- JP2/J2K читаются отдельным Worker из файла до **64 МиБ**: до **8 Мп** при 8 битах и **4 Мп** при 16 битах на канал. Поддерживаются целые несубдискретизированные Gray/RGB/RGBA; точные 16-битные отсчёты остаются доступны анализу, а экранный предварительный растр имеет 8 бит. ICC переносится только при сохранении JP2 без изменения размера; прочие метаданные не копируются.

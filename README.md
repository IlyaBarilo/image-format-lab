...
| BMP | При поддержке варианта BMP браузером | Собственные кодировщики BMP 24-bit и 32-bit |
| TIFF | Через встроенные UTIF / libjpeg-turbo, включая JPEG-in-TIFF и lossless JPEG в пределах поддержки | Собственный TIFF RGBA8 с Deflate, без потерь |
...
```text
image-format-lab.html            Готовое самостоятельное приложение
src/                            HTML-шаблон, CSS и JS-модули
scripts/                        Сборка, npm-манифесты и подготовка библиотек
.github/                        Проверки Actions и ручной выпуск по тегу

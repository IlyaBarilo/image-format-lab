...
| JPEG XL | Встроенный libjxl 0.12.0 | **JPEG XL** с качеством 1–100 или отдельный **JPEG XL lossless**; усилие кодирования 1–10. В «Экспериментах» доступно отдельное преобразование исходного JPEG в JXL с побайтовым восстановлением JPEG |
...
PNG16, поддерживаемый TIFF16 и JPEG 2000 без потерь сохраняют 16-битные отсчёты
...
- HEIC, AVIF, JPEG XL и TIFF открываются в отдельных Worker; входной файл — до **256 МиБ**. TIFF16 в указанном наборе сохраняет RGBA16 отдельно от 8-битного просмотра; остальные перечисленные кодеки выдают RGBA8.

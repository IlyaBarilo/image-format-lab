...
| BMP | Встроенный libnsbmp: палитры, RGB555/565, RGB24/32, RLE4/8 и битовые маски в пределах поддержки | Собственные кодировщики BMP 24-bit и 32-bit |
...
Настройки сжатия TIFF открываются кнопкой **Настройки…** у варианта и в окне
пакетной конвертации. Они меняют размер файла и время обработки, сохраняя

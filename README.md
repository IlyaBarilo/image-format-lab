...
| Найти отличия в изображении | Карты различий, гистограмма и профиль попиксельных ошибок RGB/alpha с исходником; MAE и RMSE по точным RGBA8/16 пикселям, выбор области для всех графиков |

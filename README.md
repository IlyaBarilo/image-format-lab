...
| PNG · палитра | Браузер | Собственный кодировщик с pako: 2–256 цветов, дизеринг, двоичная прозрачность; индексы 1/2/4/8 бит |
...
**PNG · палитра** и собственный **GIF** используют одинаковое преобразование цветов
...
показывает число записанных и фактически использованных индексов палитры;

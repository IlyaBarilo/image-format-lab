...
| --- | --- |
| Сравнить форматы | Два или четыре варианта одного исходника, синхронный масштаб и перемещение, режим 100%, фон для проверки прозрачности |
...
- Серия качества сравнивает два формата на одном исходнике, показывает размер,
  ...
  в заданном бюджете и недоминируемые точки.

...
| Исследовать цвет и яркостный сигнал | Панель «Анализ»: гистограммы RGB/alpha/Y′CbCr, Waveform яркости и RGB, RGB/Y′CbCr Parade, вектороскоп и плотностная диаграмма CIE xy для текущих 2/4 ячеек, общие шкалы и подложка |

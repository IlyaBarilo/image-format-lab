...
(async()=>{
  ...
  try{
    ...
    await page.locator('#gridModeJpeg').click();
    assert.equal(await page.locator('#gridModeJpeg').getAttribute('aria-checked'),'true');
    ...
    console.log('PASS offline wipe view, keyboard divider, pixel/JPEG grids, four-cell restoration');

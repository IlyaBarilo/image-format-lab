...
const tests = ['publication-policy', 'build-regressions', 'build-version', 'release-workflow', 'release-publishing', 'preferences', 'theme', 'source-packages', 'codec-compression', 'core-regressions', 'canvas-layout', 'analysis-layout', 'analysis-visibility', 'analysis-viewport', 'analysis-overlay', 'analysis-delta', 'file-import', 'jpeg-regressions', 'tiff-regressions', 'viewer-files', 'viewer-batch', 'viewer-batch-dialog', 'viewer-batch-preview', 'viewer-enhancements', 'viewer-analysis', 'viewer-waveform', 'viewer-difference', 'viewer-vectorscope-profile', 'viewer-analysis-output', 'browser-regressions', 'heic-regressions', 'heic-encode-regressions', 'modern-regressions', 'standalone-release'];
